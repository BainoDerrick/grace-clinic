            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 w-full">
                ...
                <div class="bg-white rounded-[2.5rem] overflow-hidden border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 group">
                    <div class="relative h-80 overflow-hidden">
                        ...
                        <img src="<?= base_url('assets/images/Sharif.png') ?>" alt="Doctor 2" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    ...
                    <div class="p-8 text-center">
                        <h3 class="text-2xl font-bold text-slate-900 mb-1">Mukalazi Sharif </h3>
                        <p class="text-blue-600 font-medium mb-4 italic">Medical Laboratory Assistant (MLA)</p>

                        <div class="w-16 h-1 bg-blue-100 mx-auto mb-6 rounded-full"></div>

                        <p class="text-slate-500 mb-8 leading-relaxed">
                            With over 2 years of dedicated experience in diagnostic excellence, Mukalazi Sharif is a vital part of the clinical team at Grace Medical Clinic. Registered with the Allied Health Professionals Council (AHPC), they emphasize laboratory safety, and high-quality results management.
                        </p>

                        <a href="https://wa.me/256757861238?text=Hello%20Grace%20Medical%20Clinic%2C%20I%20would%20like%20to%20book%20an%20appointment%20specifically%20with%20Mr.%20Mukalazi%20Sharif." class="inline-flex items-center justify-center w-full py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-blue-600 transition-colors gap-2">
                            <i class="fa-solid fa-calendar-check"></i> Book Appointment
                        </a>
                    </div>
                </div>
